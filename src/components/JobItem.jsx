      ...
      >
        <div className="flex items-center flex-col md:flex-row justify-between">
          ...
          <div className="flex items-center w-full gap-4">
            <p className="font-bold text-left md:text-right w-full">{item.experience}</p>
      ...
      >
        <div className="bg-[#241D41] mt-2 p-6 px-6">
          ...
          <div className="flex items-center mt-2">
            <p className="w-full text-white">{item.description}</p>
            {item?.logo && (
              <img className="w-1/5 h-10" src={item.logo} alt="Company Logo" />
            )}
          </div>
