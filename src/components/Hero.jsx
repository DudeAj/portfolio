  ...
  return (
    <div className="h-[85vh] relative overflow-hidden">
      ...
      <div className="relative z-10 px-2 flex flex-col items-center justify-center h-full">
        ...
        <motion.p
          className="text-xl uppercase font-normal w-3/4 text-white text-center tracking-widest leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, ease: "easeOut", delay: 0.2 }}
        >
          I’m Ajay Kumar Gangwar, a Senior Full Stack Developer focused on
          building fast, scalable, and SEO-optimized web applications with
          React.js, Next.js, Node.js, and AI technologies. I turn complex ideas
          into high-performance digital products that drive real business
          impact.
        </motion.p>
