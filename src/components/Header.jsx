...
const Header = () => {
  ...
  return (
    <div className="px-10 py-8 relative flex items-center justify-center">
      <p className="absolute text-4xl font-bold left-10">
        <span className="text-sky-300">dev</span>
        <span>.Ajay</span>
        <span className="text-purple-500">_</span>
      </p>
      <nav className="flex justify-center gap-10 items-center group">
        {menus.map((item, i) => (
